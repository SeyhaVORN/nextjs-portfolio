...
const About = () => {
  return (
    <div id='about' className='w-full md:h-screen px-6 flex items-center mb-10 py-20'>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          <p className='uppercase text-xl tracking-widest text-[#5651e5]'>About</p>
          <h2 className='py-4 italic font-mono font-style'>SEYHA VORN</h2>
        ...
        <div className='flex justify-center items-center'>
          <motion.div
            ...
            className='sm:max-w-[80%] w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300'>
